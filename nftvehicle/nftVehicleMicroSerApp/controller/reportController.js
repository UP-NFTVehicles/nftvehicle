...
async function callingToEndLifeCycle(req,fn){
	console.log("OK");
	...
	try {
        ...
        try {
/***************************************/
			userContract.methods.reportEndLifeCycle(tokenId,description).send({from: legalOwner, gas:gas })
...
initializer.reportEndLifeCycle = function (req, res){
	...
	var obj={body:
		...
		if(errNum){  //				
			...
			//callingToEndLifeCycle(obj,function(resul){// this function is async
			callingReport(obj,"reportEndLifeCycle",function(resul){// this function is async
...
initializer.reportAsStolen = function (req, res){
	...
	var obj={body:
		...
		if(errNum){  //				
			...
			callingReport(obj,"reportAsStolen",function(resul){// this function is async
				res.send(resul); //because of that this line is required
			});
		}
	if(resul.Result=="Error"){
